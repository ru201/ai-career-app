...
export default function Activities() {
    ...
    const buttonStyle = { width: 0.6, height: '3em', borderRadius: 3, fontSize: '0.55em' };
    const completeButtonStyle = { width: 0.6, height: '3em', borderRadius: 3, fontSize: '0.55em', backgroundColor: '#33B249', '&:hover': {backgroundColor: '#2CA740'} };
